...
export const menuItems = [
  // SALADS
  {
    id: 'sal-1', name: 'Classic Caesar Salad', category: 'salads', price: 189, calories: 420,
  ...
  {
    id: 'sal-2', name: 'Mediterranean Greek Bowl', category: 'salads', price: 219, calories: 380,
  ...
  {
    id: 'sal-3', name: 'Avocado Citrus Kale Crunch', category: 'salads', price: 239, calories: 460,
  ...
  // BURGERS
  {
    id: 'brg-1', name: 'Happybreak Prime Angus Burger', category: 'burgers', price: 249, calories: 780,
  ...
  {
    id: 'brg-2', name: 'Truffle Mushroom Swiss Burger', category: 'burgers', price: 279, calories: 740,
  ...
  {
    id: 'brg-3', name: 'Smoky Chipotle Black Bean Burger', category: 'burgers', price: 219, calories: 520,
  ...
  // SANDWICHES
  {
    id: 'snd-1', name: 'Artisanal Turkey Avocado Club', category: 'sandwiches', price: 199, calories: 590,
  ...
  {
    id: 'snd-2', name: 'Tuscan Grilled Chicken Panini', category: 'sandwiches', price: 229, calories: 610,
  ...
  // WRAPS
  {
    id: 'wrp-1', name: 'Buffalo Chicken Crunch Wrap', category: 'wraps', price: 189, calories: 650,
  ...
  {
    id: 'wrp-2', name: 'Roasted Hummus Veggie Wrap', category: 'wraps', price: 169, calories: 440,
  ...
  // DRINKS
  {
    id: 'drk-1', name: 'Fresh House Citrus Mint Lemonade', category: 'drinks', price: 79, calories: 140,
  ...
  {
    id: 'drk-2', name: 'Artisanal Cold Brew Iced Coffee', category: 'drinks', price: 99, calories: 15,
  ...
  {
    id: 'drk-3', name: 'Sparkling Hibiscus Berry Iced Tea', category: 'drinks', price: 89, calories: 80,
  ...
  // DESSERTS
  {
    id: 'dst-1', name: 'Warm Molten Dark Chocolate Lava Cake', category: 'desserts', price: 149, calories: 580,
  ...
  {
    id: 'dst-2', name: 'New York Style Berry Cheesecake', category: 'desserts', price: 139, calories: 520,
